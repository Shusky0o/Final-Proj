    ...
    <header className="z-[100] bg-white px-12 py-5 flex items-center justify-between w-full border-b border-gray-100 sticky top-0">
      <div className="flex items-center gap-6">
        ...
        <div className="flex flex-col">
          ...
          <div className="flex items-center gap-2">
             <span className="text-2xl font-black text-[#1A2B47]">Welcome, <span className="text-[#4475C4]">Admin!</span></span>
      ...
      <div className="flex items-center gap-6">
        <div ref={reminderRef} className="relative">
          ...
          {showReminders && (
            <div className="absolute top-full mt-4 left-0 translate-x-12 w-80 bg-white rounded-[2rem] shadow-2xl p-6 border border-gray-100 z-[110]">
              ...
              <form onSubmit={addReminder} className="mb-4 flex gap-2">
                <input type="text" value={newReminder} onChange={(e) => setNewReminder(e.target.value)} placeholder="New task..." className="flex-1 bg-gray-50 rounded-xl px-4 py-2 text-sm outline-none border border-gray-100" />
