...
export const StatsPulse = () => (
  <section className="space-y-6 flex flex-col h-full overflow-y-auto pr-2">
    ...
    <div className="bg-white rounded-[2.5rem] p-8 shadow-xl shadow-gray-200/50 border border-white transition-all hover:scale-[1.02]">
