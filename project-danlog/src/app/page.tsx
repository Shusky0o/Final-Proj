...
export default function AdminDashboard() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-[#EAEFF9] via-[#FFFFFF] to-[#D9E2F3] flex flex-col font-sans text-black overflow-x-hidden">
      ...
      <div className="p-12 grid grid-cols-1 lg:grid-cols-12 gap-8 w-full max-w-[1700px] mx-auto">
        ...
        <div className="lg:col-span-6 flex flex-col items-center justify-center gap-12">
          ...
          <div className="flex flex-col gap-6 w-full max-w-[400px]">
            <button className="relative group bg-[#4475C4] text-white py-6 rounded-2xl font-black text-xl uppercase tracking-[0.2em] transition-all hover:scale-105 active:scale-95 shadow-[0_20px_50px_rgba(68,117,196,0.3)] overflow-hidden">
        ...
        <div className="lg:col-span-3 flex flex-col gap-8">
          ...
          <div className="bg-gradient-to-br from-yellow-400 to-orange-300 rounded-[2rem] p-8 shadow-xl text-black">
            ...
            <p className="mt-4 font-bold bg-white/30 w-fit px-4 py-1 rounded-full text-xs">Immediate Action Required</p>
          </div>
